  ...
  return (
    ...
    >
      ...
      <div className="h-[340px] min-h-[340px]">
        {chartData.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center rounded-xl border border-dashed border-neutral-700 bg-neutral-950/70 px-6 text-center">
            <p className="font-mono text-xs font-bold uppercase tracking-[0.28em] text-neutral-500">
              Awaiting Multi-Car Stream
            </p>
            <p className="mt-3 max-w-xl text-sm leading-6 text-neutral-400">
              {emptyMessage ?? "No aligned telemetry samples are available for this session and car pair."}
            </p>
            <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.22em] text-neutral-600">
              Ingest two cars with matching session_id to render the delta overlay
            </p>
          </div>
        ) : (
